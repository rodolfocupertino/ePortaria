...
class Messages {
	...
	var $msgClass = 'alert alert-block fade in';
	//var $msgWrapper = "<div class='%s %s'><a href='#' class='closeMessage'></a>\n%s</div>\n";
	var $msgWrapper = "<div class='%s alert-%s alert-dismissible'>
	...
	public function add($type, $message, $redirect_to=null) {
		...
		if( strlen(trim($type)) == 1 ) {
			$type = str_replace( array('h', 'i', 'w', 'd', 's'), array('help', 'info', 'warning', 'danger', 'success'), $type );
